...
* Descarrega el fitxer [`AdventureWorksBackup`](https://github.com/fbarraga/Postgres-DB/blob/main/UF2/Databases/adventureworks/AdventureWorksBackup) que tens al repositori de  Github i copia'l a la carpeta `/tmp` del servidor PostGres utilitzant el Winscp:
